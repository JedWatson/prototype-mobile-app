...
// This is heavily based on the touch plugin for Zepto.js, and
// customised to work with jQuery 2.0 (plus some other tweaks)
// 
// It adds the following events and methods to jQuery collections:
// 
// *	`swipe`
// *	`swipeLeft`
// *	`swipeRight`
